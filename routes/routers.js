...
router.get("/allCourses", (req, res) => {
    const run = async function () {
        const docVar = await controller.allCourses();
...
router.get("/allPrograms", (req, res) => {
    ...
    const run = async function () {
        const docVar = await controller.allPrograms();
        return res.send(docVar);
    };
    run();
    // connectDbServer();
...
router.get("/allTeachers", (req, res) => {
    ...
    const run = async function () {
        const docVar = await controller.allTeachers();
        return res.send(docVar);
    };
    run();
    // connectDbServer();
...
router.get("/allApplications", (req, res) => {
    const run = async function () {
        const docVar = await controller.allApplications();
        return res.send(docVar);
    };
    run();
    // connectDbServer();
...
router.get("/allApplicants", (req, res) => {
    const run = async function () {
        const docVar = await controller.allApplicants();
        return res.send(docVar);
    };
    run();
    // connectDbServer();
...
//     const run = async function () {
//         const controller = require("./controller.js");
//         const docVar = await controller.allCoursesPopulatePrograms();
//         return res.send(docVar);
//     };
//     run();
//     // connectDbServer();
...
router.get("/CousesOfAnEmail/:_email", (req, res) => {
    ...
    const run = async function () {
        const data = await controller.cousesOfAnEmail(_email);
    ...
    try {
        ...
        if (title && desc) {
            ...
            const run = async function () {
                ...
                program = await controller.addProgram(data);
    ...
    try {
        ...
        if (programId && title && date1 && date2 && teacher && status) {
            const run = async function () {
                ...
                docVar = await controller.addCourse(data);
                console.log("\n>> New Course doc:\n", docVar);

                // add Program To Course
                docVar = await controller.addProgramToCourse(docVar._id, programId);
    ...
    try {
        ...
        if (course_id && name && age && email && phone && comment && requestDate) {
            const run = async function () {
                ...
                // docVar = await controller.addApplicant(applicantData);
                docVar = await controller.addApplicant(applicantData);
                ...
                docVar = await controller.addApplicationLinkApplicatAndCourse(applicationData)
                // return res.send(docVar);
